...
export default function CreateFond({ setTableRows, allSections }) {
    ...
    if (titre) {
      postData("/fond", token, tokenType, {
        ...
        .then((res) => {
          ...
          getData("/fond/all", token, tokenType).then((res) => {
  ...
  return (
    <Fragment>
      <Button
        ...
        size="sm"
      >
        <UserPlusIcon strokeWidth={2} className="h-4 w-4" /> Ajouter un Fond
      </Button>
      <Dialog open={open} handler={handleOpen}>
        ...
        <div className="mx-10 mb-2">
          ...
          >
            Erreur de creation d'un nouveau Fond !
          </Alert>
          <Alert
            color="green"
