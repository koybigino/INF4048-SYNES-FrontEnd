      ...
      <>
        <div className='w-full flex justify-between space-x-2 mt-6 mx-2'>
          ...
          <div className='w-1/2 px-4'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum omnis facere iste magni necessitatibus earum consequuntur ut velit ipsa nemo odit soluta, eos quibusdam sunt aliquam recusandae hic modi vitae?
          </div>
        </div>
      </>
    );
