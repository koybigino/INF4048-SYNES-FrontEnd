...
export default function Error() {
    ...
    <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-gray-600 my-12">Sorry, the page you are looking for could not be found.</p>
        <p className="cursor-pointer flex items-center space-x-2 bg-elle transition duration-300 easy-in-out hover:bg-aim text-gray-100 px-4 py-3 rounded-lg font-bold"
            onClick={()=>{navigate('/')}}>
