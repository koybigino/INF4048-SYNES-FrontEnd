...
import { postData, putData } from '../../../../config/apiFunctions'

export default function EditProfile() {
	const currentUser = useRecoilValue(storeUserGet)
	const imageref = useRef()
	const [imagePath, setImagePath] = useState(
		currentUser.photo ? currentUser.photo.link : ''
	)
	...
	const updateProfile = async (user) => {
		setLoading(true)
		postData('/user/photo', token, tokenType, photo)
			.then((res) => {
				console.log(res)
			})
			.catch((e) => {
					...
					<Card color='transparent' shadow={false}>
						...
						>
							...
							<div className='mt-10'>
								...
								>
									Erreur de la mise à jour des information du
									membre{' '}
